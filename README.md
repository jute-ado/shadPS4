...
| --- | --- | --- |
| **Uncharted 1: Drake's Fortune** | Reaches gameplay and has progressed at least into the cave. Targeted native-scale fixes address the earlier orange/zebra lighting and first-use white hair/spider-web material failures. | The experimental 200% internal render-scale cave path remains incorrect, and longer-game validation is incomplete. |
