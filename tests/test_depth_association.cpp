...
TEST(DepthAssociation, RedirectsOnlyStencilCompatibleViews) {
    EXPECT_TRUE(VideoCore::ShouldUseAssociatedDepthForView(vk::Format::eS8Uint));
    ...
    EXPECT_FALSE(VideoCore::ShouldUseAssociatedDepthForView(vk::Format::eR8Sint));
    EXPECT_FALSE(VideoCore::ShouldUseAssociatedDepthForView(vk::Format::eR16G16B16A16Sfloat));
