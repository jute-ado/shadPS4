...
log, terminates the complete process tree at the deadline, and writes
`game-test-report.json`.
...
bounded output, JSON reports, safe artifact names, and hard timeout behavior.
