...
public:
    ...
    /// Atomically associates a completion with this exact GPU submission.
    void FlushWithGpuCompletion(Common::UniqueFunction<void>&& completion);
...
private:
    ...
    void SubmitExecutionWithSubmitLockHeld(SubmitInfo& info);
