...
void SharedMemoryBarrierPass(IR::Program& program, const RuntimeInfo& runtime_info,
    ...
    // Guest shaders can use wave-synchronous LDS accesses inside a larger workgroup. Preserve
    // their visibility on hosts whose subgroups are narrower than a GCN wave; the pass already
    // avoids inserting barriers in divergent control flow.
