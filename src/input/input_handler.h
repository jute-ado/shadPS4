...
#define SDL_EVENT_INJECT_GAMEPAD_BUTTON SDL_EVENT_USER + 16
#define SDL_EVENT_INJECT_GAMEPAD_AXIS SDL_EVENT_USER + 17
#define SDL_EVENT_INJECT_GAMEPAD_TOUCH SDL_EVENT_USER + 18
