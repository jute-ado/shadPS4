...
struct GPUSettings {
    ...
    Setting<u32> internal_resolution_scale{100};
    ...
    std::vector<OverrideItem> GetOverrideableFields() const {
        return std::vector<OverrideItem>{
            ...
            make_override<GPUSettings>("internal_screen_height",
                                       &GPUSettings::internal_screen_height),
            make_override<GPUSettings>("internal_screen_width",
                                       &GPUSettings::internal_screen_width),
            make_override<GPUSettings>("internal_resolution_scale",
                                       &GPUSettings::internal_resolution_scale),
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(GPUSettings, window_width, window_height, internal_screen_width,
                                   internal_screen_height, internal_resolution_scale, null_gpu,
...
#define SETTING_FORWARD_BOOL_READONLY(group, Name, field)                                          \
    ...
    SETTING_FORWARD(m_gpu, InternalResolutionScale, internal_resolution_scale)
